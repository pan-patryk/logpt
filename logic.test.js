...
test('should return the same array as on site', () => {
    ...
    expect(value).toEqual([1, 2,"fizz fizz", 4,"buzz buzz","fizz", 7,8,"fizz","buzz", 11,"fizz","fizz", 14,"lucky",16, 17,"fizz", 19,"buzz"])
})

test('should return error when called without arguments', () => {
  const value = logic();
